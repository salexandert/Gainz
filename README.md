...
7. Open **Tax Filing Review** and build the year-by-year tax evidence inventory.
...
The audit packet includes the Excel workbook, Form 8949 detail CSVs, Form 8949 totals, tax filing review, tax evidence inventory, holdings reconciliation, current holdings lots, import warnings with review decisions, missing-basis review, source-overlap review, copied source files when available, hashes, and a methodology memo.
