...
class LauncherStartupTests(unittest.TestCase):
    ...
    def test_release_build_scripts_bundle_gainz_icons(self):
        ...
        self.assertIn(r'"venv\Scripts\python.exe"', windows_script)
        self.assertIn('if ($LASTEXITCODE -ne 0)', windows_script)
        self.assertIn("No release package was created.", windows_script)
        self.assertIn("expected executable", windows_script)
