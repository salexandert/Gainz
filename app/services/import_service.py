...
class ImportService:
    ...
    def import_mapped_file(self, file_path, transactions, header_row, column_mapping):
    ...
    def analyze_import_file(self, file_path, header_row=None, column_mapping=None):
    ...
    def _mapping_required_result(self, file_path, analysis):
        return {
            "file_path": file_path,
            "imported_count": 0,
            "skipped_count": 0,
            "warnings": [
                "Gainz could not identify the required import columns. Choose the header row and map the columns below."
            ],
